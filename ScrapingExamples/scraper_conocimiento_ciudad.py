"""
scraper_conocimiento_ciudad.py — Descargador masivo Conocimiento Esencial · Escuela Inteligente v4
Especializado en: Textos, obras, lenguajes, refranes, idiosincrasia, literatura antioqueña, 
cultura popular, parlache y narrativas fundacionales de Medellín.
"""
...
HEADERS = {
    "User-Agent": (
        "EscuelaInteligente-CulturaBot/4.0 "
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOGS_DIR / "scraper_conocimiento.log", encoding="utf-8"),
        logging.StreamHandler(),
    ],
)
log = logging.getLogger(__name__)

TARGET_CAT = "Conocimiento esencial de la ciudad"

# ══════════════════════════════════════════════════════════════════════════
# FUENTES 1: CRAWLING INSTITUCIONAL Y CULTURAL DE MEDELLÍN
# ══════════════════════════════════════════════════════════════════════════
CRAWL_SOURCES = [
    {
        "name": "Banco de la República - Colección Antioquia",
        "base_url": "https://www.banrepcultural.org",
        "start_urls": [
            "https://www.banrepcultural.org/medellin",
            "https://babel.banrepcultural.org/digital/collection/p17054coll18", # Publicaciones
        ],
        "category": TARGET_CAT,
        "link_keywords": [
            "pdf", "descarg", "historia", "cultura", "antioquia", "medellin", "paisa", "literatura"
        ],
    },
    {
        "name": "Biblioteca Pública Piloto y Sistema de Bibliotecas",
        "base_url": "https://www.bibliotecasmedellin.gov.co",
        "start_urls": [
            "https://www.bibliotecasmedellin.gov.co/",
            "https://escolares.bibliotecasmedellin.gov.co/"
        ],
        "category": TARGET_CAT,
        "link_keywords": [
            "pdf", "libro", "descarg", "publicacion", "cultura",
            "historia", "medellin", "memoria", "patrimonio"
        ],
    },
    {
        "name": "Fondo Editorial Universidad EAFIT",
        "base_url": "https://www.eafit.edu.co",
        "start_urls": ["https://www.eafit.edu.co/cultura/fondo-editorial/Paginas/fondo-editorial-eafit.aspx"],
        "category": TARGET_CAT,
        "link_keywords": ["pdf", "open access", "descarg", "literatura", "antioquia", "memoria", "lectura"],
    },
    {
        "name": "Red de Bibliotecas UdeA (Memoria Antioqueña)",
        "base_url": "https://bibliotecas.udea.edu.co",
        "start_urls": ["https://bibliotecas.udea.edu.co/"],
        "category": TARGET_CAT,
        "link_keywords": ["pdf", "descargar", "repositorio", "historia antioquia", "memoria", "cultura"],
    }
]
...
API_SOURCES = [
    {
        "name": "CORE - Idiosincrasia y Cultura Popular",
        "type": "core",
        "category": TARGET_CAT,
        "queries": [
            "cultura popular Medellín",
            "literatura antioqueña",
            "narrativas fundacionales Medellín",
            "parlache Medellín",
            "refranes y tradiciones Antioquia",
            "idiosincrasia paisa",
            "cuentos y leyendas Medellín",
            "memoria histórica Medellín",
            "patrimonio cultural Medellín"
        ],
        "max_per_query": 50,
    },
    {
        "name": "OpenAlex - Investigación en Sociología, Lenguaje e Historia Local",
        "type": "openalex",
        "category": TARGET_CAT,
        "queries": [
            "historia urbana Medellín",
            "lenguaje popular Medellín parlache",
            "sociología cultura paisa",
            "literatura de Medellín",
            "expresiones culturales Antioquia",
            "identidad paisa",
            "mitos leyendas Antioquia"
        ],
        "max_per_query": 50,
    },
    {
        "name": "Semantic Scholar / Zenodo - Archivos Abiertos",
        "type": "zenodo",
        "category": TARGET_CAT,
        "queries": [
            "Medellín cultura",
            "Antioquia historia y memoria",
            "literatura colombiana Medellín",
            "parlache lenguaje",
            "patrimonio Antioquia"
        ],
        "max_per_query": 40,
    }
]
...
class ScraperConocimiento:
    ...
    def _download_pdf(self, url, category, name, verify=True):
        ...
        log.info(f"✓ Conocimiento/{fname} ({total/1024:.0f} KB) - {name}")
        with self._lock:
    ...
    def run(self):
        log.info("═" * 65)
        log.info("ESCUELA INTELIGENTE — Scraper Conocimiento Ciudad Ultra-Fast")
        log.info("═" * 65)
        ...
        log.info("\n═" * 65)
        log.info("RESUMEN FINAL CONOCIMIENTO CIUDAD")
