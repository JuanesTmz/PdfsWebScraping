"""
scraper_geografia.py — Descargador masivo Geografía Educativa Medellín · Escuela Inteligente v4
Especializado en: Instituciones educativas, bibliotecas, parques, políticas educativas locales,
Parque Explora, Jardín Botánico, Ruta N y Secretaría de Educación.
"""
...
LOGS_DIR            = Path("logs")
DELAY               = (0.01, 0.05)           # Pausa mínima
MAX_DOCS_PER_SOURCE = 600                    # Alto límite para descargas
MAX_PAGES_PER_CRAWL = 150                    # Exploración profunda
MAX_PDF_BYTES       = 50 * 1024 * 1024       # 50 MB límite por archivo
MAX_WORKERS         = 30                     # Concurrencia ultra alta

HEADERS = {
    "User-Agent": (
        "EscuelaInteligente-GeografiaBot/4.0 "
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOGS_DIR / "scraper_geografia.log", encoding="utf-8"),
        logging.StreamHandler(),
    ],
)
log = logging.getLogger(__name__)

# Categoría Destino Fija
TARGET_CAT = "La geografía educativa de la Ciudad"

# ══════════════════════════════════════════════════════════════════════════
# FUENTES 1: CRAWLING INSTITUCIONAL DE MEDELLÍN
# ══════════════════════════════════════════════════════════════════════════
CRAWL_SOURCES = [
    {
        ...
        "start_urls": [
            ...
            "https://www.medellin.gov.co/es/secretaria-de-educacion/programas/",
        ],
        "category": TARGET_CAT,
        "link_keywords": [
            "educacion", "plan", "programa", "docente", "pdf", "descarg",
            "informe", "institucion", "colegio", "escuela", "politica", "comuna"
        ],
    },
    {
        "name": "Parque Explora - Educación",
        "base_url": "https://www.parqueexplora.org",
        "start_urls": ["https://www.parqueexplora.org/educadores/"],
        "category": TARGET_CAT,
        "link_keywords": ["recurso", "guia", "taller", "docente", "pdf", "descarg"],
    },
    {
        ...
        "category": TARGET_CAT,
        "link_keywords": ["educacion", "pdf", "descarg", "innovacion", "tecnologia"],
    },
    {
        "name": "Jardín Botánico de Medellín",
        "base_url": "https://www.jardinbotanico.org.co",
        "start_urls": ["https://www.jardinbotanico.org.co/"],
        "category": TARGET_CAT,
        "link_keywords": ["educacion", "pdf", "recurso", "descarg", "guia"],
    },
    {
        "name": "Bibliotecas de Medellín",
        "base_url": "https://www.bibliotecasmedellin.gov.co",
        "start_urls": ["https://www.bibliotecasmedellin.gov.co/"],
        "category": TARGET_CAT,
        "link_keywords": ["pdf", "libro", "descarg", "comunidad", "medellin", "lectura"],
    }
]

# ══════════════════════════════════════════════════════════════════════════
# FUENTES 2: APIs DOCUMENTALES (MÁXIMA VELOCIDAD Y VOLUMEN)
# Consultas especializadas en el ecosistema educativo de la ciudad.
# ══════════════════════════════════════════════════════════════════════════
API_SOURCES = [
    {
        "name": "OpenAlex - Investigación Educación Medellín",
        "type": "openalex",
        "category": TARGET_CAT,
        "queries": [
            "educación Medellín",
            "instituciones educativas Medellín",
            "colegios públicos Medellín",
            "políticas educativas Medellín",
            "Parque Explora educación",
            "Jardín Botánico Medellín educación",
            "Ruta N innovación educativa",
            "bibliotecas públicas Medellín educación",
            "comunas Medellín educación y sociedad"
        ],
        "max_per_query": 60,
    },
    {
        "name": "CORE - Recursos y Teoría Educativa (Hispano)",
        "type": "core",
        "category": TARGET_CAT,
        "queries": [
            "educación básica Medellín",
            "programas educativos Alcaldía de Medellín",
            "geografía escolar Medellín",
            "infraestructura educativa Medellín",
            "Secretaría de Educación Medellín",
            "Buen Comienzo Medellín educación"
        ],
        "max_per_query": 50,
    },
    {
        "name": "SciELO API / Semantic Scholar - Local Context",
        "type": "semantic_scholar",
        "category": TARGET_CAT,
        "queries": [
            "public schools Medellin education",
            "Medellin educational policy",
            "Medellin libraries education",
            "Medellin educational geography"
        ],
        "max_per_query": 40,
    }
]
...
class ScraperGeografia:
    ...
    def _download_pdf(self, url, category, name, verify=True):
        ...
        # NOTA: NO se escriben archivos .meta.json como fue solicitado.
        log.info(f"✓ Geografía/{fname} ({total/1024:.0f} KB) - {name}")
        with self._lock:
    ...
    def run(self):
        log.info("═" * 65)
        log.info("ESCUELA INTELIGENTE — Scraper Geografía Educativa Ultra-Fast")
        log.info("═" * 65)
        ...
        log.info("\n═" * 65)
        log.info("RESUMEN FINAL GEOGRAFÍA EDUCATIVA")
